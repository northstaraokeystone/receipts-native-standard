# Receipts-Native Working Group Charter
...
The Receipts-Native Working Group exists to:

1. **Define** the receipts-native category with an executable, verifiable standard
2. **Maintain** the canonical definition and compliance test suite
3. **Enable** ecosystem builders to implement and certify receipts-native systems
4. **Promote** adoption across high-consequence domains (government, healthcare, autonomous systems, defense)
...
| Name | Organization | Role | Joined |
|------|--------------|------|--------|
| Matthew Cook | Keystone Research Lab | Founder/Chair | 2024-12 |
...
- Enterprise compliance practitioner
- Government/defense systems architect
- Healthcare/FDA regulatory expert
- Autonomous systems engineer
- Open source infrastructure maintainer

**Goal:** 5 members by March 2025, 7 by June 2025
...
- **Emergency:** Chair + 2 members can act, subject to next meeting ratification
...
1. **Production Implementation:** Receipts-native system deployed in production
...
2. Provide:
   - Your background and organization
...
4. **Vote:** Steering committee votes (7 days)
...
- Legacy compliance tests maintained for 1 major version
...
- **Implementations:** No IP restrictions; implementations may be proprietary
- **Certification marks:** TBD (working group will define usage terms)
...
- **Seat Limits:** Maximum 2 members from same organization
- **Diverse Industries:** Target representation from 5+ industries
- **Open Process:** All proposals and votes public
- **Fork Rights:** Anyone can fork standard under CC-BY-4.0
...
- 30-day notice before vote
- Published rationale for changes
...
*This charter is effective as of 2024-12-30 and will be reviewed annually.*
